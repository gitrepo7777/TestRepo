 ...
 *   &lt;complexContent>
 *     &lt;extension base="{http://www.fpml.org/2009/FpML-4-7}Asset">
 *       &lt;sequence>
 *         &lt;element name="openUnits" type="{http://www.w3.org/2001/XMLSchema}decimal" minOccurs="0"/>
 *         &lt;element name="basketConstituent" type="{http://www.fpml.org/2009/FpML-4-7}BasketConstituent" maxOccurs="unbounded"/>
 ...
 *         &lt;element name="basketCurrency" type="{http://www.fpml.org/2009/FpML-4-7}Currency" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
    ...
    extends Asset
{
    ...
    @XmlElementRefs({
        ...
        @XmlElementRef(name = "basketDivisor", namespace = "http://www.fpml.org/2009/FpML-4-7", type = JAXBElement.class),
        @XmlElementRef(name = "basketName", namespace = "http://www.fpml.org/2009/FpML-4-7", type = JAXBElement.class),
        @XmlElementRef(name = "openUnits", namespace = "http://www.fpml.org/2009/FpML-4-7", type = JAXBElement.class),
        @XmlElementRef(name = "basketConstituent", namespace = "http://www.fpml.org/2009/FpML-4-7", type = JAXBElement.class),
        @XmlElementRef(name = "basketCurrency", namespace = "http://www.fpml.org/2009/FpML-4-7", type = JAXBElement.class)
    })
