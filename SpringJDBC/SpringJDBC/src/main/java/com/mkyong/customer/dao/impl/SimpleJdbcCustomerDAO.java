...
public class SimpleJdbcCustomerDAO extends SimpleJdbcDaoSupport implements CustomerDAO
{
	...
	public void insertBatchNamedParameter2(final List<Customer> customers){
        ...
        getSimpleJdbcTemplate().batchUpdate(
                "INSERT INTO mydb..CUSTOMER (CUST_ID, NAME, AGE) VALUES (:custId, :name, :age)",
                params);
	...
	public Customer findByCustomerId(int custId){
		...
		String sql = "SELECT * FROM mydb..CUSTOMER WHERE CUST_ID = ?";
	...
	public String findCustomerNameById(int custId){
		...
		String sql = "SELECT NAME FROM mydb..CUSTOMER WHERE CUST_ID = ?";
	...
	public int findTotalCustomer(){
		...
		String sql = "SELECT COUNT(*) FROM mydb..CUSTOMER";
