...
public class JdbcTemplateApp 
{
    public static void main( String[] args )
    {
    	...
    	//it's better to create an unit test rather than testing like this :)
         ...
         Customer customer1 = new Customer(1, "Vani1",21);
         Customer customer3 = new Customer(2, "Vani2",22);
         Customer customer2 = new Customer(3, "Vani3",23);
         ...
         for(Customer cust: customerAs){
         	 System.out.println("Customer As : " + customerAs.toString());
         }
        
         List<Customer> customerBs = customerDAO.findAll2();
         for(Customer cust: customerBs){
         	 System.out.println("Customer Bs : " + customerBs.toString());
         }
